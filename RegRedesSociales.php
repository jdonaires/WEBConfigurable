...
<?php
require_once('PHP/BOL/RedesSociales.php');
require_once('PHP/DAO/RedesSocialesDAO.php');
				  ...
				  <div class="card-body">
				    ...
				    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post" enctype="multipart/form-data">
					  	...
					  	<div class="form-group row">
					    	...
					    	<div class="col-sm-8">
					      		<input type="text" class="form-control" id="enlace" placeholder="Añadir Enlace:" name="TxtEnlace">
					    	</div>
					  	</div>
					  	<!--<div class="form-group row">
					  	...
					  	<div class="form-group row">
					    	...
					    	<div class="col-sm-8">
					      		<input type="file" id="archivo" value="Seleccionar Archivo" name="TxtImagen">
					    	</div>
					  	</div>
					  	<div class="form-group row">
					  		<div class="col-sm-3"></div>
