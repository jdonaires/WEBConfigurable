...
-- -----------------------------------------------------
-- Table `PagAdmin`.`Cabecera`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PagAdmin`.`Cabecera` (
...
-- -----------------------------------------------------
-- Table `PagAdmin`.`Slider`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PagAdmin`.`Slider` (
  ...
  INDEX `fk_Slider_Usuario1_idx` (`IdUsuario` ASC),
